...
public class Variable_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_pfjbyg_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_pfjbyg_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_pfjbyg_c0(EditorContext editorContext, SNode node) {
